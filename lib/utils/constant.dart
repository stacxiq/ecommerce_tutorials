import 'package:ecommerce_tutorials/models/paymentModal.dart';
import 'package:flutter/material.dart';

const base_url = 'http://164.92.249.184:8009/api/';
const image_url = 'http://164.92.249.184:8009';
const kPrimaryColor = Color(0xFF146EBE);
const kSecondaryColor = Color(0xFFFFD43B);
...
List<Map<String, String>> introData = [
  {
    ...
    'headText': 'كوزمو ستور',
    'descText':
        " تمتع ب افضل العروض والتخفيضات ، مع تسوق من مختلف المتاجر العالمية داخل تطبيق كوزمو ",
  },
  {
    'image': trophy,
    'headText': 'توصيل',
    'descText': " يتوفر توصيل لمختلف المحافظات مع افضل عروض التوصيل ",
  },
  {
    'image': chat,
    'headText': 'براندات',
    'descText':
        "يتوفر داخل متجرنا جميع البراندات العالمية مع عروض تخفيضات مجزية ",
  },
];
